...
Command logic lives in: commands/moderation.js, information.js, utility.js
...
async function updatePanel(guildId) {
    ...
    try {
        ...
        // เฟส 2: บันทึก panel state ลง DB
...
async function handleMessage(message) {
    ...
    // เฟส 22: /snipe ถูกตัดออกตามที่ตกลง — ดูข้อความที่ลบได้จาก #log-ข้อความ แทน
}
